...
module QueryDefinition implements ResultQuerySig<DefaultQueryModel>
{
    ...
    predicate results_tags(ResultAnchor aresult, DefaultQueryModel::Tag tag){none()}
    predicate results_properties(ResultAnchor aresult, DefaultQueryModel::Property property){none()}
}
